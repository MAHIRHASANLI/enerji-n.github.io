...
(function ($, Drupal, window) {
  ...
  function callAfterAjax() {
    ...
    $(".view-kategorie > .view-content .views-row .views-row-fieldset").click(function () {
      window.location = $(this).find(".views-field-name a").attr("href");
      return false;
    });

    $('.form-type-managed-file a[data-toggle="popover"]').once('already-proccessed').click(function () {
  ...
  function afterReady() {
    ...
    if ($('.view-partneri-obsah>.view-content>.partneri-content').length == 6) {//na vývoji jich je 5
      //$('.view-partneri-obsah>.view-content>.partneri-content').last().clone().appendTo(".view-partneri-obsah>.view-content");
      $("<div class='partneri-content'><div id=\"geofield-map-view-mapa-partneru-block-1\" class=\"geofield-google-map\" style=\"min-width: 200px; width: 100%; min-height: 200px; height: 600px\"></div>\n</div>").prependTo(".view-partneri-obsah>.view-content");
    }
    ...
    $('.field--name-field-produkt-zalozky').slick({
      slidesToShow: 1,
      slidesToScroll: 1,
      arrows: false,
      draggable: false,
    ...
    $('.view-zalozky .view-content').slick({
      slidesToShow: 50,
      slidesToScroll: 1,
      asNavFor: '.field--name-field-produkt-zalozky',
      arrows: false,
      draggable: false,
      infinite: false,
      swipe: false,
    ...
    $('.view-partneri-obsah .view-content').slick({
      slidesToShow: 1,
      slidesToScroll: 1,
      arrows: false,
      draggable: false,
    ...
    $('.view-partneri-kategorie .view-content').slick({
      slidesToShow: 50,
      slidesToScroll: 1,
      asNavFor: '.view-partneri-obsah .view-content',
      arrows: false,
      draggable: false,
      infinite: false,
      swipe: false,
    ...
    //odstraňování duplicit - je ještě potřeba?
    /*if($('.view-soubory-ke-stazeni').length) {
      console.log($('.view-soubory-ke-stazeni .views-row .views-field-field-soubor-soubor a').length);
      $.each($('.view-soubory-ke-stazeni .views-row .views-field-field-soubor-soubor a'),function(index,value){
        link = $(this).attr('href');
        console.log(link);
        console.log('.view-soubory-ke-stazeni a[href="' + link + '"]');
        i = 0;
        $('.view-soubory-ke-stazeni a[href="' + link + '"]').each(function () {
          if (i > 0) {
